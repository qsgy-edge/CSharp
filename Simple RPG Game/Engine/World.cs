...
namespace Engine
{
    public static class World
    {
        ...
        {
            Items.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "生锈的剑", 0, 5));
            Items.Add(new Item(ITEM_ID_RAT_TAIL, "老鼠尾巴"));
            Items.Add(new Item(ITEM_ID_PIECE_OF_FUR, "皮毛"));
            Items.Add(new Item(ITEM_ID_SNAKE_FANG, "蛇牙"));
            Items.Add(new Item(ITEM_ID_SNAKESKIN, "蛇皮"));
            Items.Add(new Weapon(ITEM_ID_CLUB, "棍子", 3, 10));
            Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "治疗药水", 5));
            Items.Add(new Item(ITEM_ID_SPIDER_FANG, "蜘蛛牙"));
            Items.Add(new Item(ITEM_ID_SPIDER_SILK, "蜘蛛丝"));
            Items.Add(new Item(ITEM_ID_ADVENTURER_PASS, "勇者通行证"));
        }
